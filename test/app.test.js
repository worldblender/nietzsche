...
setTimeout(function() {
  ...
  exports.players = function(assert) {
    ...
    p = models.Player("coffee1", new models.Coords(-122.329779, 47.604359));
    p = models.Player("coffee2", new models.Coords(-122.329798, 47.604402));
    p = models.Player("coffee3", new models.Coords(-122.329599, 47.602469));
    p = models.Player("coffee4", new models.Coords(-122.330905, 47.604007));
    p = models.Player("coffee5", new models.Coords(-122.33046, 47.60506));
    p = models.Player("coffee6", new models.Coords(-122.331462, 47.602865));
    p = models.Player("coffee7", new models.Coords(-122.329689, 47.60146));
    p = models.Player("coffee8", new models.Coords(-122.332252, 47.603602));
